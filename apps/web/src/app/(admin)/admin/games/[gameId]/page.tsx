...
export default function AdminGameReviewPage({ params }: PageProps) {
  const { gameId } = params;
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 bg-gray-900 min-w-0">
        ...
        <Link href="/admin/games" className="mt-4 text-white/40 hover:text-white/70 text-xs transition-colors">
          ← Back to all games
        </Link>
      </div>
